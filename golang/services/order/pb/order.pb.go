...
func (*Order_OrderProduct) Descriptor() ([]byte, []int) {
	return file_services_order_order_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*PostOrderRequest_OrderProduct) Descriptor() ([]byte, []int) {
	return file_services_order_order_proto_rawDescGZIP(), []int{1, 0}
}

func (x *PostOrderRequest_OrderProduct) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_services_order_order_proto_rawDesc = "" +
	"\n" +
	"\x1aservices/order/order.proto\x12\x02pb\"\xb0\x02\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\bquantity\x18\x03 \x01(\rR\bquantity\x1a:\n" +
	"\fOrderProduct\x12\x0e\n" +
